    ...
    return (
        <div>
            <footer className="bg-neutral-primary">
                <div className="mx-auto w-full max-w-screen-xl border-[#F2F4F7]  px-4 py-3 shadow-[inset_0px_2px_4px_0px_rgba(184,196,243,0.14),0px_3px_10px_0px_rgba(16,24,40,0.1)]">
